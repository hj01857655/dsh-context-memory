 ...
 * reports as "loaded without registering 'dsh-context-memory' via __ModuleLoader__.load".
 *
...
await build({
  ...
  banner: {
    ...
    js: 'window.__ModuleLoader__.load({ id: "dsh-context-memory", factory: (require) => {'
