/**
 * Browser half of dsh-context-memory: its page inside Settings.
 *
...
import { ContextMemoryPanel } from './view.js'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { zh, en }), 'dsh-context-memory: dictionaries')
